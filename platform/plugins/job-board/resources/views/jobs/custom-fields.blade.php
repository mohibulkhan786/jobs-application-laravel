<div class="job-custom-fields-wrap">
    ...
    <div class="d-flex justify-content-between">
        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addNewCustomFieldModal">{{ trans('plugins/job-board::custom-fields.add_a_new_custom_field') }}</button>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <label for="custom-field-id">{{ trans('plugins/job-board::custom-fields.modal.select_field') }}</label>
                        <div class="ui-select-wrapper">
                            <select class="form-control ui-select" id="custom-field-id">
                                ...
                                @foreach($customFields as $customField)
                                    <option value="{{ $customField->id }}">{{ $customField->name }} ({{ $customField->type->label() }})</option>
                                @endforeach
                            </select>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="add-new">{{ trans('plugins/job-board::custom-fields.modal.button') }}</button>
                </div>
            </div>
        </div>
    </div>

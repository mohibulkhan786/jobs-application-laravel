    ...
    WithMapping
{
    ...
    {
        $companies['country_id'] = Arr::first($this->getIdsFromString(Arr::get($row, 'country'), $this->countryRepository));
        $companies['state_id'] = Arr::first($this->getIdsFromString(Arr::get($row, 'state'), $this->stateRepository));
        $companies['city_id'] = Arr::first($this->getIdsFromString(Arr::get($row, 'city'), $this->cityRepository));
        $companies['accounts'] = $this->getIdsFromString(Arr::get($row, 'account_manager'), $this->accountRepository, 'first_name');

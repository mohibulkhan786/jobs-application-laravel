    ...
    WithMapping
{
    ...
    {
        $account['country_id'] = Arr::first($this->stringToModelIds(Arr::get($row, 'country'), $this->countryRepository));
        $account['state_id'] = Arr::first($this->stringToModelIds(Arr::get($row, 'state'), $this->stateRepository));
        $account['city_id'] = Arr::first($this->stringToModelIds(Arr::get($row, 'city'), $this->cityRepository));

...
class ImportCompanyController extends BaseController
{
    ...
    {
        PageTitle::setTitle(trans('plugins/job-board::import.name'));
    ...
    public function store(BulkImportRequest $request, BaseHttpResponse $response, ImportCompanies $importCompanies)
    {

...
class HookServiceProvider extends ServiceProvider
{
    ...
    public function languageMetaField(): string|null
    {
        ...
        $queryParams['ref_from'] = ! empty($args[0]) && $args[0]->id ? $args[0]->id : 0;
    ...
    public function checkCurrentLanguage(array|\Illuminate\Database\Eloquent\Collection $languages, string|null $value): ?LanguageModel
    {
            ...
            if (! empty($data)) {
                ...
                if ($current) {
                    ...
                    if ($current->lang_meta_code != Language::getCurrentLocaleCode()) {
                        if (
                            ! setting('language_show_default_item_if_current_version_not_existed', true) &&

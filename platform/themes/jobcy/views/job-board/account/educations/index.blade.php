...
@section('content')
    <div class="col-lg-12">
        <div class="form-group mt-10">
            <a href="{{ route('public.account.educations.create') }}" class="btn btn-primary btn-brand icon-tick">{{ __('Add Education') }}</a>
        </div>
    </div>
        ...
        @forelse($educations as $education)
            <div class="item-timeline">
                ...
                <div class="timeline-info">
                    <h5 class="color-brand-1 title-name">
                        {{ $education->school }}
                ...
                <div class="timeline-actions">
                    <a href="{{ route('public.account.educations.edit', $education->id) }}" class="btn btn-editor">
